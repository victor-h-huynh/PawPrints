        ...
        return (
            <div className="Home">
              ...
              <h4>Welcome to Paw Prints</h4>
                <Map updatePetsOnMap={this.props.updatePetsOnMap} pets={this.props.pets} petsOnMap={this.props.petsOnMap} users={this.props.users} addresses={this.props.addresses}/>
