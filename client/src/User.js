...
class User extends Component {
  ...
  render() {
    ...
    if (levels === 2) {
      badge2 = <img id="badge2" style={currentBadgeStyle} src="https://gamepedia.cursecdn.com/dota2_gamepedia/thumb/7/76/SeasonalRank4-1.png/140px-SeasonalRank4-1.png?version=7a9db7f22e02de4a58923f40da38b9db" />
    } else {
      badge2 = <img id="badge2" style={badgeStyle} src="https://gamepedia.cursecdn.com/dota2_gamepedia/thumb/7/76/SeasonalRank4-1.png/140px-SeasonalRank4-1.png?version=7a9db7f22e02de4a58923f40da38b9db" />
    }
    if (levels === 3) {
