    ...
    return (
      <React.Fragment>
        ...
        <Switch>
              ...
              <Route path="/Pets/:id" render={props => <PetProfile {...props} pets={this.state.pets} users={this.state.users} current_user={this.state.current_user} addresses={this.state.addresses}/>}/>
